  ...
  return (
    <div>
      ...
      <li className='list-none '>${product.new_price}</li>
       ...
       </div><br /><br /><br /><br /><button className='text-white bg-gray-900 mt-8 w-28 h-10 rounded-md hover:scale-105 duration-500' onClick={()=> Additem(product)}>Add To Cart</button>
